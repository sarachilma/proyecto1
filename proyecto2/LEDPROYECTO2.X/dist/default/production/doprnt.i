...
{
    int i;
# 205 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
 if (p < 0) {
  p = 0;
 }
    i = 0;
...
# 1176 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
static void
...
# 1201 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
    if ((*fmt)[0] == '%') {
        ...
        flags = width = 0;
        prec = -1;
# 1273 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\sources\\c99\\common\\doprnt.c"
        if ((*fmt)[0] == 'c') {
            ++*fmt;
