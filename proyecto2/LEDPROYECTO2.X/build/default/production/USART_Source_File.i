...
# 2 "<built-in>" 2
# 1 "USART_Source_File.c" 2
# 17 "USART_Source_File.c"
# 1 "./USART_Header_File.h" 1
# 19 "./USART_Header_File.h"
...
void USART_Init(long baud_rate)
{
    ...
    TRISC6 = 0;
    TRISC7 = 1;
    temp = (((float)(8000000UL/64)/(float)baud_rate)-1);
    SPBRG = (int)temp;
    TXSTA = 0x20;
    RCSTA = 0x90;
}
...
void SoftUSART_TxChar(char data)
{
    char i;
    LATBbits.LATB0 = 0;
    _delay((unsigned long)(((1000000 / 9600))*(8000000UL/4000000.0)));

    for (i = 0; i < 8; i++) {
        LATBbits.LATB0 = (data >> i) & 1;
        _delay((unsigned long)(((1000000 / 9600))*(8000000UL/4000000.0)));
    }
...
char SoftUSART_RxChar()
{
    ...
    _delay((unsigned long)(((1000000 / 9600) + (1000000 / 9600) / 2)*(8000000UL/4000000.0)));
