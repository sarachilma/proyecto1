...
void LCD_Command(unsigned char cmd) {
    LATD = (unsigned char)((LATD & 0x0F) | (0xF0 & cmd));
    LATD0 = 0;
    LATD1 = 1;
    __nop();
    LATD1 = 0;
    ...
    LATD = (unsigned char)((LATD & 0x0F) | ((cmd & 0x0F) << 4));
    LATD1 = 1;
    __nop();
    LATD1 = 0;
...
void LCD_Char(unsigned char dat) {
    LATD = (unsigned char)((LATD & 0x0F) | (0xF0 & dat));
    LATD0 = 1;
    LATD1 = 1;
    __nop();
    LATD1 = 0;
    ...
    LATD = (unsigned char)((LATD & 0x0F) | ((dat & 0x0F) << 4));
    LATD1 = 1;
    __nop();
    LATD1 = 0;
    _delay((unsigned long)((3)*(8000000/4000.0)));
