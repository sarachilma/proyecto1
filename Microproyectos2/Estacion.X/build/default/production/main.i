...
volatile unsigned char system_state = 1;
...
void __attribute__((picinterrupt(("high_priority")))) HighPriorityISR() {
...
void Display_RTC() {
    ...
    while (refresh_count < 5 && system_state == 1) {
