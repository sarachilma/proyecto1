 ...
 * Author: G3PQ2L3
 *
 * Created on 14 de marzo de 2025, 06:13 PM
 */
...
void main(void) {
    ...
    OSCCON = 0x07;  // Configurar el oscilador interno a 31 kHz

    while (1) {
        LATAbits.LATA0 = 1;  // Encender el LED en RA0
        __delay_ms(2500);     // Esperar 500 ms

        LATAbits.LATA0 = 0;  // Apagar el LED en RA0
        __delay_ms(1000);     // Esperar 500 ms
    }
}
